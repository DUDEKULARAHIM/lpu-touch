...
// all your imports remain exactly as before …
import AlumniMentorSelection from "../assets/dash/securityscan.png";
import AssignmentMarks from "../assets/dash/caMarks.png";
import BookAppointment from "../assets/dash/auth.png";
import CampusTour from "../assets/dash/threed.png";
...
const data = {
  links: [
    { id: 1, text: "Alumni Mentor Selection", imageURL: AlumniMentorSelection, url: "/loading" },
    { id: 2, text: "Assignment Marks", imageURL: AssignmentMarks, url: "/loading" },
    { id: 3, text: "Book Appointment", imageURL: BookAppointment, url: "/loading" },
    { id: 4, text: "Campus Tour", imageURL: CampusTour, url: "/loading" },
    { id: 5, text: "Change UMS Password", imageURL: ChangeUMSPassword, url: "/loading" },
    { id: 6, text: "Continue Exit Undertaking", imageURL: ContinueExitUndertaking, url: "/loading" },
    { id: 7, text: "Doctor Appointment", imageURL: DoctorAppointment, url: "/loading" },
    { id: 8, text: "Document Upload Page", imageURL: DocumentUploadPage, url: "/loading" },
    { id: 9, text: "Electives Polling", imageURL: ElectivesPolling, url: "/loading" },
    { id: 10, text: "EM Area Preference", imageURL: EMAreaPreference, url: "/loading" },
    { id: 11, text: "Exam Attendance", imageURL: ExamAttendance, url: "/loading" },
    { id: 12, text: "Fee Payment Schedule", imageURL: FeePaymentSchedule, url: "/loading" },
    { id: 13, text: "Fee Statement", imageURL: FeeStatement, url: "/loading" },
    { id: 14, text: "Guest Lecture/Workshop Feedback", imageURL: GuestLecture, url: "/loading" },
    { id: 15, text: "Hostel Leave Slip", imageURL: HostelLeaveSlip, url: "/loading" },
    { id: 16, text: "Central", imageURL: Inventory, url: "/central" },
    { id: 17, text: "North", imageURL: LabFeedback, url: "/north" },
    { id: 18, text: "Language Lab Slot Booking", imageURL: LanguageLabSlotBooking, url: "/loading" },
    { id: 19, text: "Lecture Feedback", imageURL: LectureFeedback, url: "/loading" },
    { id: 20, text: "Library Resource Feedback", imageURL: LibraryResourceFeedback, url: "/loading" },
    { id: 21, text: "Log RMS Request", imageURL: LogRMSRequest, url: "/" },
    { id: 22, text: "Make Up Adjustment", imageURL: MakeUpAdjustment, url: "/loading" },
    { id: 23, text: "Mess Food Feedback", imageURL: MessFoodFeedback, url: "/loading" },
    { id: 24, text: "Mess Food Scanner", imageURL: MessFoodScanner, url: "/mess" },
    { id: 25, text: "Open Elective Course Preference", imageURL: OpenElectiveCoursePreference, url: "/loading" },
    { id: 26, text: "PEP Activities", imageURL: PEPActivities, url: "/loading" },
    { id: 27, text: "Placement Barcode Scanner", imageURL: PlacementBarcodeScanner, url: "/loading" },
    { id: 28, text: "Placement Drive", imageURL: PlacementDrive, url: "/loading" },
    { id: 29, text: "Placement Drive Summary", imageURL: PlacementDriveSummary, url: "/loading" },
    { id: 30, text: "Railway Concession Form", imageURL: RailwayConcessionForm, url: "/loading" },
    { id: 31, text: "ReAppear Registration", imageURL: ReAppearRegistration, url: "/loading" },
    { id: 32, text: "Reset Internet Password", imageURL: ResetInternetPassword, url: "/loading" },
    { id: 33, text: "Residential Reporting Slip", imageURL: ResidentialReportingSlip, url: "/reporting" },
    { id: 34, text: "RMS Request Status", imageURL: RMSRequestStatus, url: "/loading" },
    { id: 35, text: "Skill Development Feedback", imageURL: SkillDevelopmentFeedback, url: "/loading" },
    { id: 36, text: "Special Food Services", imageURL: SpecialFoodServices, url: "/loading" },
    { id: 37, text: "Student Class Feedback", imageURL: StudentClassFeedback, url: "/loading" },
    { id: 38, text: "Summer Term Registration", imageURL: SummerTermRegistration, url: "/loading" },
    { id: 39, text: "Teacher on Leave", imageURL: TeacheronLeave, url: "/loading" },
    { id: 40, text: "Time table", imageURL: Timetable, url: "/loading" },
    { id: 41, text: "Transport Facility Preference", imageURL: TransportFacilityPreference, url: "/loading" },
    { id: 42, text: "Uni Hospital Help Line", imageURL: UniHospitalHelpLine, url: "/loading" },
    { id: 43, text: "Vendor Facility Search", imageURL: VendorFacilitySearch, url: "/loading" },
    { id: 44, text: "View Marks", imageURL: ViewMarks, url: "/loading" },
    { id: 45, text: "Visitor Gate Pass", imageURL: VisitorGatePass, url: "/loading" },
  ],
};
  ...
  return (
    <>
      ...
      <motion.div
        ...
        initial={{ opacity: 0, x: "-100%" }}
        animate={isOpen ? "open" : "closed"}
        className="fixed inset-y-0 left-0 z-50 w-[75%] sm:w-[300px] h-full bg-white shadow-[10px_0px_190px_-15px_rgba(0,0,0,0.3)]"
      >
        <div className="flex flex-col h-64 bg-gradient-to-r from-[#fc7b73] to-[#ffd97a] items-center justify-center shadow-md">
          <a href="/profile">
            <img
          ...
          <h1 className="text-black font-semibold mt-2">{personalInfo.name}</h1>
          <p className="text-xs text-black">{personalInfo.reg}</p>
        ...
        <div className="px-3 py-2 mt-1">
          <div className="flex items-center bg-gray-200 rounded-lg">
            <BsSearch className="ml-3 text-xl text-gray-500" />
            <input
              className="w-full h-9 px-3 rounded-lg bg-gray-200 focus:outline-none"
              placeholder="Search"
              onChange={handleSearch}
            />
          </div>
        ...
        {/* Menu items */}
        <div className="flex flex-col mt-1 overflow-y-scroll no-scrollbar h-[70%] pb-16">
          {menuItems.map((link) => (
            <a href={link.url} key={link.id} onClick={onClose}>
              <SideMenu text={link.text} imageURL={link.imageURL} />
            </a>
          ))}
        </div>
        ...
        <div className="fixed bottom-0 w-full p-4 bg-white border-t">
          <button
            ...
            className="w-full py-2 text-sm tracking-wider rounded-full shadow-md bg-gradient-to-r from-[#fc7b73] to-[#ffd97a]"
          >
            LOGOUT
          </button>
        </div>
